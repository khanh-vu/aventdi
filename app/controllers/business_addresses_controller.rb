class BusinessAddressesController < ApplicationController
  ...
  def show
    ...
    @hash = Gmaps4rails.build_markers(@business_address) do |address, marker|
  ...
  private
    ...
    def business_address_params
      params.require(:business_address).permit(:name, :business_listing_id, :address, :latitude, :longitude)
    end
end
